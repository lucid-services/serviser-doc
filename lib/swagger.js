...
var toSwagger = require('ajv2swagger').toSwagger;
...
function generate(app) {
    ...
    //var validatorManager = jsonInspectorToSwagger(app.getValidator());
...
/**
 * @param {Ajv} validator - Ajv validator instance
 *
 * @return {ValidatorManager}
 */
//function jsonInspectorToSwagger(validator) {
